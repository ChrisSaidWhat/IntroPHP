...
<html>
    ...
    <head>
        ...
        <style>
            *, :after, :before {
            ...
            tbody tr td:first-child, tbody tr td:nth-child(3), thead td:first-child, thead td:nth-child(3) {
                width: 15%
            }

            tbody tr td:nth-child(2), thead td:nth-child(2) {
                width: 20%
            }
    ...
    <body>
        ...
        <section>
            ...
            <!--                <p class="productDesc">This is a new monitor. Available for desktop uses. A good choice for home office-->
            <!--                    and school work.</p>-->
